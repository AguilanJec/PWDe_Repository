 ...
 * nothing about the engine behind it — the debug source set implements it with sherpa-onnx's
 * keyword spotter and the release source set with a no-op, so neither the model nor its native
 * libraries reach a release APK.
 *
