...
class WakeWordTuningTest {
    ...
    fun `a hand-edited pair matches no preset`() {
        assertEquals(WakeWordSensitivity.MAX, WakeWordSensitivity.presetFor(WakeWordTuning(6.0f, 0.0f)))
        ...
        assertNull(WakeWordSensitivity.presetFor(WakeWordTuning(6.1f, 0.0f)))
    }
