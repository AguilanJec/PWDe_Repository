 ...
 * the Testing Station and in-game button voice load.
 *
 * These read the model straight off disk at `src/main/assets/...` (Gradle runs unit tests from the
 * module directory). The expected tokens are upstream's, which means a pass proves the copied `bpe.model` and `tokens.txt`
...
public class GigaSpeechTokenizerTest {
  ...
  private static final String DIR =
      "src/main/assets/models/sherpa-kws-zipformer-gigaspeech-3.3M-2024-01-01/";
